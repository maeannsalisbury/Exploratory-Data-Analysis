...
if (!file.exists("./Exploratory Data Analysis/Plot2")) {
        dir.create("./Exploratory Data Analysis/Plot2")
}
...
## Create a plot of the Global Active Power plotted over days
library(datasets)
with(datafile, plot(DateTime, Global_active_power, type="l", xlab="", ylab = "Global Active Power (kilowatts)"))
dev.copy(png, file = "./Exploratory Data Analysis/Plot2/plot2.png", width=480, height=480)  ## Copy my plt to a PNG file
